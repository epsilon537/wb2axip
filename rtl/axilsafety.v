...
`endif
  ...
  localparam OKAY = 2'b00, EXOKAY = 2'b01, SLVERR = 2'b10;

  reg [LGDEPTH-1:0] aw_count, w_count, r_count;
  reg aw_zero, w_zero, r_zero, aw_full, w_full, r_full, aw_w_greater, w_aw_greater;
  ...
  reg [LGTIMEOUT-1:0] aw_stall_counter, w_stall_counter, r_stall_counter, w_ack_timer, r_ack_timer;
  reg aw_stall_limit, w_stall_limit, r_stall_limit, w_ack_limit, r_ack_limit;
  // }}}
  ////////////////////////////////////////////////////////////////////////
  //
  // Write signaling
...
`endif
  ...
  always @(*)
    if (!M_AXI_ARESETN || o_write_fault)
      ...
      awskd_ready = (w_aw_greater) || ((aw_zero) && (!S_AXI_BVALID || S_AXI_BREADY));
    else
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN) M_AXI_AWVALID <= 1'b0;
  ...
  // {{{
  always @(posedge S_AXI_ACLK)
    if (OPT_LOWPOWER && (!M_AXI_ARESETN || o_write_fault)) begin
      M_AXI_AWADDR <= 0;
      M_AXI_AWPROT <= 0;
...
`endif
  ...
  always @(*)
    if (!M_AXI_ARESETN || o_write_fault)
      wskd_ready = (aw_w_greater) || ((w_zero) && (!S_AXI_BVALID || S_AXI_BREADY));
    else wskd_ready = (!M_AXI_WVALID || M_AXI_WREADY) && (!w_full);
  // }}}
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN) M_AXI_WVALID <= 1'b0;
...
`endif
  ...
  // {{{
  always @(*)
    if (o_write_fault) bskd_ready = 1'b1;
    else bskd_ready = (!S_AXI_BVALID || S_AXI_BREADY);
  // }}}
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN) S_AXI_BVALID <= 1'b0;
      ...
      else S_AXI_BVALID <= (!downstream_aw_zero) && (!downstream_w_zero) && (bskd_valid);
    end
  // }}}
  ...
  always @(posedge S_AXI_ACLK)
    if (!M_AXI_ARESETN || o_write_fault) last_bvalid <= 1'b0;
    else last_bvalid <= (M_AXI_BVALID && !M_AXI_BREADY);
  // }}}

  // last_bdata
  // {{{
  always @(posedge S_AXI_ACLK) if (M_AXI_BVALID) last_bdata <= M_AXI_BRESP;
  // }}}

  // last_bchanged
  // {{{
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_write_fault) last_bchanged <= 1'b0;
    else last_bchanged <= (last_bvalid && (!M_AXI_BVALID || last_bdata != M_AXI_BRESP));
  // }}}
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_BVALID || S_AXI_BREADY) begin
      if (o_write_fault) S_AXI_BRESP <= SLVERR;
      else if (bskd_resp == EXOKAY) S_AXI_BRESP <= SLVERR;
      else S_AXI_BRESP <= bskd_resp;
    end
  // }}}
  // }}}
  // }}}
...
`endif
  ...
  // {{{
  always @(*)
    if (!M_AXI_ARESETN || o_read_fault) arskd_ready = ((r_zero) && (!S_AXI_RVALID || S_AXI_RREADY));
    else arskd_ready = (!M_AXI_ARVALID || M_AXI_ARREADY) && (!r_full);
  // }}}
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN) M_AXI_ARVALID <= 1'b0;
  ...
  // {{{
  always @(posedge S_AXI_ACLK)
    if (OPT_LOWPOWER && (!M_AXI_ARESETN || o_read_fault)) begin
      M_AXI_ARADDR <= 0;
      M_AXI_ARPROT <= 0;
...
`endif
  ...
  // {{{
  always @(*)
    if (o_read_fault) rskd_ready = 1;
    else rskd_ready = (!S_AXI_RVALID || S_AXI_RREADY);
  // }}}
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN) S_AXI_RVALID <= 1'b0;
      ...
      if (o_read_fault || !M_AXI_ARESETN)
        S_AXI_RVALID <= (!S_AXI_RVALID && !r_zero) || (arskd_valid && arskd_ready);
      else S_AXI_RVALID <= (!downstream_r_zero) && (rskd_valid);
    end
  // }}}
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_RVALID || S_AXI_RREADY) begin
      if (o_read_fault || !M_AXI_ARESETN) S_AXI_RDATA <= 0;
      else S_AXI_RDATA <= rskd_data;

      S_AXI_RRESP <= OKAY;
      if (o_read_fault || rskd_resp == EXOKAY || !M_AXI_ARESETN) S_AXI_RRESP <= SLVERR;
      else if (!downstream_r_zero) S_AXI_RRESP <= rskd_resp;
    end
  // }}}
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_read_fault) last_rvalid <= 1'b0;
    else last_rvalid <= (M_AXI_RVALID && !M_AXI_RREADY);
  // }}}

  // last_rdata
  // {{{
  always @(posedge S_AXI_ACLK) if (M_AXI_RVALID) last_rdata <= {M_AXI_RRESP, M_AXI_RDATA};
  // }}}

  // last_rchanged
  // {{{
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_read_fault) last_rchanged <= 1'b0;
    else
      last_rchanged <= (last_rvalid && (!M_AXI_RVALID || last_rdata != {M_AXI_RRESP, M_AXI_RDATA}));
  // }}}
  // }}}
  // }}}
  ////////////////////////////////////////////////////////////////////////
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN) begin
      ...
      case ({
        (awskd_valid && awskd_ready), S_AXI_BVALID && S_AXI_BREADY
      })
        2'b10: begin
          aw_count <= aw_count + 1;
          aw_zero  <= 0;
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN) begin
      ...
      case ({
        (wskd_valid && wskd_ready), S_AXI_BVALID && S_AXI_BREADY
      })
        2'b10: begin
          w_count <= w_count + 1;
          w_zero  <= 0;
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN) begin
      ...
      case ({
        (awskd_valid && awskd_ready), (wskd_valid && wskd_ready)
      })
        2'b10: begin
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN) begin
      ...
      case ({
        (arskd_valid && arskd_ready), S_AXI_RVALID && S_AXI_RREADY
      })
        2'b10: begin
          r_count <= r_count + 1;
          r_zero  <= 0;
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_write_fault) begin
      downstream_aw_count <= 0;
      downstream_aw_zero  <= 1;
    end else
      case ({
        (M_AXI_AWVALID && M_AXI_AWREADY), M_AXI_BVALID && M_AXI_BREADY
      })
        2'b10: begin
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_write_fault) begin
      ...
      case ({
        (M_AXI_WVALID && M_AXI_WREADY), M_AXI_BVALID && M_AXI_BREADY
      })
        2'b10: begin
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_read_fault) begin
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || o_write_fault || !M_AXI_ARESETN) begin
      aw_stall_counter <= 0;
      aw_stall_limit   <= 0;
    end else if (!M_AXI_AWVALID || M_AXI_AWREADY || M_AXI_BVALID) begin
      aw_stall_counter <= 0;
      aw_stall_limit   <= 0;
    end else if (aw_w_greater && !M_AXI_WVALID) begin
      aw_stall_counter <= 0;
      aw_stall_limit   <= 0;
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_write_fault) begin
      w_stall_counter <= 0;
      w_stall_limit   <= 0;
    end else if (!M_AXI_WVALID || M_AXI_WREADY || M_AXI_BVALID) begin
      w_stall_counter <= 0;
      w_stall_limit   <= 0;
    end else if (w_aw_greater && !M_AXI_AWVALID) begin
      w_stall_counter <= 0;
      w_stall_limit   <= 0;
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_write_fault) begin
      w_ack_timer <= 0;
      w_ack_limit <= 0;
    end else if (M_AXI_BVALID || downstream_aw_zero || downstream_w_zero) begin
      w_ack_timer <= 0;
      w_ack_limit <= 0;
    end else begin
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_read_fault) begin
      r_stall_counter <= 0;
      r_stall_limit   <= 0;
    end else if (!M_AXI_ARVALID || M_AXI_ARREADY || M_AXI_RVALID) begin
      r_stall_counter <= 0;
      r_stall_limit   <= 0;
    end else begin
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_read_fault) begin
      r_ack_timer <= 0;
      r_ack_limit <= 0;
    end else if (M_AXI_RVALID || downstream_r_zero) begin
      r_ack_timer <= 0;
      r_ack_limit <= 0;
    end else begin
  ...
  always @(posedge S_AXI_ACLK)
    if (!S_AXI_ARESETN) o_write_fault <= 1'b0;
    else if (OPT_SELF_RESET && o_write_fault) begin
      //
      // Clear any fault on reset
      if (!M_AXI_ARESETN) o_write_fault <= 1'b0;
    end else begin
      //
      // A write fault takes place if you respond without a prior
      // bus request on both write address and write data channels.
      if ((downstream_aw_zero || downstream_w_zero) && (bskd_valid)) o_write_fault <= 1'b1;

      // AXI-lite slaves are not allowed to return EXOKAY responses
      // from the bus
      if (bskd_valid && bskd_resp == EXOKAY) o_write_fault <= 1'b1;
  ...
  generate
    if (OPT_SELF_RESET) begin : SELF_RESET_GENERATION
      // {{{
      reg min_reset;

      if (OPT_MIN_RESET > 1) begin : MIN_RESET
        // {{{
        ...
        always @(posedge S_AXI_ARESETN)
          if (M_AXI_ARESETN) begin
            ...
            min_reset <= 1'b0;
          end else if (!M_AXI_ARESETN) begin
            if (reset_counter > 0) reset_counter <= reset_counter - 1;
            min_reset <= (reset_counter <= 1);
          end

`ifdef FORMAL
        always @(*) assert (reset_counter < OPT_MIN_RESET);
        always @(*) assert (min_reset == (reset_counter == 0));
`endif
        // }}}
      end else begin
        // {{{
        always @(*) min_reset = 1'b1;
        // }}}
      end
      ...
      always @(posedge S_AXI_ACLK)
        if (!S_AXI_ARESETN) M_AXI_ARESETN <= 1'b0;
        else if (o_write_fault || o_read_fault) M_AXI_ARESETN <= 1'b0;
      ...
      //
      always @(*) M_AXI_ARESETN = S_AXI_ARESETN;
      // }}}
    end
  endgenerate
  // }}}
...
`ifdef FORMAL
  ...
  //
  //
  wire [LGDEPTH:0] faxils_awr_outstanding, faxils_wr_outstanding, faxils_rd_outstanding;
  ...
  always @(*) begin
    ...
    //
    if (M_AXI_ARESETN && !o_write_fault) begin
      assert (downstream_aw_zero == (downstream_aw_count == 0));
      assert (downstream_w_zero == (downstream_w_count == 0));
      assert (downstream_aw_count + (M_AXI_AWVALID ? 1 : 0) + (S_AXI_BVALID ? 1 : 0) == aw_count);
      assert (downstream_w_count + (M_AXI_WVALID ? 1 : 0) + (S_AXI_BVALID ? 1 : 0) == w_count);
    end

    if (M_AXI_ARESETN && !o_read_fault) begin
      assert (downstream_r_zero == (downstream_r_count == 0));
      assert (downstream_r_count + (M_AXI_ARVALID ? 1 : 0) + (S_AXI_RVALID ? 1 : 0) == r_count);
    end
    //
  ...
  // }}}
  generate
    if (F_OPT_FAULTLESS) begin : ASSUME_FAULTLESS
      // {{{
      ////////////////////////////////////////////////////////////////
      //
      ...
      ////////////////////////////////////////////////////////////////
      //
      wire [LGDEPTH:0] faxilm_awr_outstanding, faxilm_wr_outstanding, faxilm_rd_outstanding;
      ...
      // {{{
      always @(*) assert (!o_write_fault);
      always @(*) assert (!o_read_fault);
      // }}}
      // }}}
      ////////////////////////////////////////////////////////////////
      //
...
`endif
      ...
      if (OPT_SELF_RESET) begin
        ...
        always @(posedge S_AXI_ACLK)
          if (!S_AXI_ARESETN) write_faulted <= 0;
          else if (o_write_fault) write_faulted <= 1;


        initial faulted = 0;
        always @(posedge S_AXI_ACLK)
          if (!S_AXI_ARESETN) read_faulted <= 0;
          else if (o_read_fault) read_faulted <= 1;

        always @(*) faulted = (write_faulted || read_faulted);

        always @(posedge S_AXI_ACLK) cover (write_faulted && $rose(M_AXI_ARESETN));

        always @(posedge S_AXI_ACLK) cover (read_faulted && $rose(M_AXI_ARESETN));

        always @(posedge S_AXI_ACLK) cover (faulted && M_AXI_ARESETN && S_AXI_BVALID);

        always @(posedge S_AXI_ACLK) cover (faulted && M_AXI_ARESETN && S_AXI_RVALID);


        initial cvr_writes = 0;
        always @(posedge S_AXI_ACLK)
          if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_write_fault) cvr_writes <= 0;
          else if (write_faulted && S_AXI_BVALID && S_AXI_BREADY
        && S_AXI_BRESP == OKAY
        &&(!(&cvr_writes)))
            cvr_writes <= cvr_writes + 1;

        always @(*) cover (cvr_writes > 5);

        initial cvr_reads = 0;
        always @(posedge S_AXI_ACLK)
          if (!S_AXI_ARESETN || !M_AXI_ARESETN || o_read_fault) cvr_reads <= 0;
          else if (read_faulted && S_AXI_RVALID && S_AXI_RREADY
        && S_AXI_RRESP == OKAY
        &&(!(&cvr_reads)))
            cvr_reads <= cvr_reads + 1;

        always @(*) cover (cvr_reads > 5);
        // }}}
      end
  ...
  (* anyconst *) reg [C_AXI_DATA_WIDTH+C_AXI_DATA_WIDTH/8-1:0] fc_never_write_data;

  (* anyconst *) reg [C_AXI_ADDR_WIDTH-1:0] fc_never_read_addr, fc_never_write_addr;

  // Write address checking
  // {{{
  always @(*) if (S_AXI_ARESETN && S_AXI_AWVALID) assume (S_AXI_AWADDR != fc_never_write_addr);
  ...
  // {{{
  always @(*) if (S_AXI_ARESETN && S_AXI_ARVALID) assume (S_AXI_ARADDR != fc_never_read_addr);
